...
print("Nous avons", len(liste_personnes), "participants")#affiche le nombre des particpants du bootcamp(130)
...
print("Nous avons",nombre_personnes_ville("Paris",liste_personnes),"participants de Paris")
print("Nous avons",nombre_personnes_ville("Bamako",liste_personnes),"participants de Bamako")
print("Nous avons",len(liste_personnes),"participants") #affiche le nombre des particpants du bootcamp(131) apres l'ajout de fatima
def ajouter_personne(liste_personnes,nom, age, ville):#fonction pour ajouter des nouveaux participants
